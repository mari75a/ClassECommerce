    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 bg-light text-center">
                <label class="form-label text-primary fw-bold fs-1">Manage Teachers</label>
            </div>
            ...
            for ($x = 0; $x < $selected_num; $x++) {
                ...
                $prof_rs = Database::search("SELECT * FROM `teacher` WHERE `email`='" . $selected_data["email"] . "'");
                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-2 d-none d-lg-block bg-light py-2" onclick="m('<?php echo $selected_data['email']; ?>');">
                            ...
                            ?>
                                <img src="<?php echo $prof_data['timage']; ?>" style="height: 40px;margin-left: 80px;" />
                            <?php
                        ...
                        <div class="col-4 col-lg-2 secondcolor py-2">
                            <span class="fs-4 text-white"><?php echo $selected_data["first_name"] . " " . $selected_data["last_name"]; ?></span>
                        </div>
                        ...
                        <div class="col-2 col-lg-1 bg-white py-2 d-grid">
                            ...
                            ?>
                                <button id="ub<?php echo $selected_data['email']; ?>" class="btn btn-danger" onclick="blockTeachers('<?php echo $selected_data['email']; ?>');">Block</button>
                            <?php
                            } else {
                            ?>
                                <button id="ub<?php echo $selected_data['email']; ?>" class="btn btn-success" onclick="blockTeachers('<?php echo $selected_data['email']; ?>');">Unblock</button>
                            <?php
