...
<body>
    ...
    <footer class="bg-dark text-white mt-3 pb-5 pt-4">

        <div class="col-12 text-md-start">
            <div class="row text-sm-center text-md-start">

                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    <h5 class="text-uppercase mt-4 text-warning">E-WINGS</h5>
                    <p>Here we are the EWings.lk&trade; to support you for accomplish your desire by selling high
                        quality products.</p>
                </div>

                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    <p>Copyright &copy; 2023 E_WINGS All Rights Reserved</p>
                </div>
                ...
                <p><i class="bi bi-at"></i> EWings@gmail.com</p>
