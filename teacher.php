...
?>
                        ...
                        <div class="col-lg-2 bg-dark ">
                            <div class="row">
                                <div class="col-lg-12 d-flex flex-column">
                                    <div class="row">
                                        <div class="col-lg-12 mt-lg-3  border border-dark btn btn-success" onclick="myProfile();" style="height: 60px;border-width:5px;  ">
                                        ...
                                        <div class="col-lg-12 mt-lg-3   border border-dark  navc text-white butn" onclick="manageCourse();" style="height: 60px;border-width:5px;  ">
                                            <div class="container-fluid d-flex justify-content-center">
                                                <div class="row align-content-center">
                                        ...
                                        <div class="col-lg-12 mt-lg-3   border border-dark  navc text-white butn" onclick="sellingHistory();" style="height: 60px;border-width:5px;  ">
                                            <div class="container-fluid d-flex justify-content-center">
                                                <div class="row align-content-center">
                                                    <label for="" class="form-label fw-bold mt-3">Selling History</label>
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 offset-3 mt-3">
            <button class="btn btn-primary col-6 col-lg-12" onclick="mn();">Update Profile</button>
        </div>
    </div>
</div>
                                    </div>
