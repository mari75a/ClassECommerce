...
$rs = Database::search("SELECT * FROM `teacher` WHERE `email`='".$email."' OR `mobile_no`='".$mobile."'");
$n = $rs->num_rows;
...
if($n > 0){
    ...
    (`first_name`,`last_name`,`email`,`mobile_no`,`password`,`gender_id`,`joined_date`,`status`) VALUES 
