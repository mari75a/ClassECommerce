    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 mt-2" id="viewArea">
                ...
                INNER JOIN `teacher_has_course` ON `teacher_has_course`.`course_course_id`=`course`.`course_id`
                INNER JOIN `teacher` ON `teacher_has_course`.`teacher_id`=`teacher`.`id` WHERE `email`='".$_SESSION["t"]["email"]."' ";
                $pageno;
